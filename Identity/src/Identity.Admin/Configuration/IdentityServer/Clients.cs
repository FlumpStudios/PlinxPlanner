    ...
    public class Clients
    {
        ...
        public static IEnumerable<Client> GetAdminClient(IAdminConfiguration adminConfiguration)
        {
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                    ClientId ="DealLogAPISwagger",                   
                    Enabled = true,
                    ProtocolType = "oidc",
                    RequireClientSecret = false,
                    ClientName = "Deal Log Swagger Access",
                    Description = "Deal Log Swagger Access",
                    ClientUri = "http://localhost:5200",
                    ...
                    RedirectUris = {"http://localhost:5200/oauth2-redirect.html"},
                ...
                new Client
                {
                    ...
                    Description = "React Client for the Deal log API",
                    ...
                    RedirectUris = {"http://localhost:5100/callback", "http://localhost:5100/silent_renew.html"},
